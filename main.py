...
load_dotenv(override=False) # Only load .env in development
...
def load_model_and_tokenizer(model_id):
    # Check environment variable and device
    quantize_model = os.getenv('QUANTIZE_MODEL') == 'TRUE'
    device = 'cuda' if torch.cuda.is_available() else 'cpu'
    
    if quantize_model and device == 'cuda':
        ...
        print("Quantization not enabled or not supported on the current device.")
